...
import { FiLock, FiPackage, FiCheck, FiArrowRight, FiShield } from 'react-icons/fi';
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-slate-800/90 backdrop-blur-xl py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-slate-700">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            >
              {isSubmitting ? 'Authenticating...' : 'Sign In to Workspace'} <FiArrowRight className="ml-2 h-4 w-4" />
            </button>
          </form>
        </div>
      </div>
